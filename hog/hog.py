...
def boar_brawl(player_score, opponent_score):
    ...
    """
    # BEGIN PROBLEM 2
    val1 = (opponent_score//10) % 10
    val2 = player_score % 10
    if(3 * abs(val1 - val2) == 0):
        return 1
    else:
        return 3 * abs(val1 - val2)
    # END PROBLEM 2
...
def is_always_roll(strategy, goal=GOAL):
    ...
    while (k<=goal-1):
        ...
        while(i<=goal-1):
            ...
            if(not(strategy(k, i) == strategy(k, i-1))):
                return False
            i+=1
        k+=1
...
def boar_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    val1 = boar_brawl(score, opponent_score)
    if (val1>=threshold):
        return 0
    else:
        return num_rolls
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    tot=score+diff
    if((sus_points(tot) - score) >= threshold):
        return 0
    else:
        return num_rolls
