...
def do_define_form(expressions, env):
    ...
    if scheme_symbolp(signature):
        ...
        procedure = LambdaProcedure(formals, args, env)
...
def do_and_form(expressions, env):
    ...
    """
    # BEGIN PROBLEM 12
    from scheme import nil, scheme_eval
from scheme_utils import is_scheme_false, is_scheme_true
...
def do_and_form(expressions, env):
    ...
    last_val = scheme_eval(loc.first, env)
    return last_val
